...
const DpiChanger = () => {
    ...
    return (
        <>
            <SEOHead
                title="DPI Changer - Adjust Image Resolution"
                description="Change image DPI/PPI settings for print or web use. Optimize resolution without losing quality with our free online DPI tool."
                canonicalUrl="/categories/optimize/dpi"
            />
