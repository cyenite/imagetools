    ...
    return (
        <>
            <SEOHead
                ...
                description="Compress images while maintaining visual quality. Reduce file sizes for faster website loading with our free online image compressor."
                canonicalUrl="/categories/optimize/compress"
            />
