...
const CircleCropper = () => {
    ...
    return (
        <>
            <SEOHead
                title="Circle Crop Tool - Create Circular Profile Pictures"
                description="Crop images into perfect circles. Ideal for profile pictures and avatars with our free online circle cropping tool."
                canonicalUrl="/categories/resize/crop-circle"
            />
