...
const ImageCompressor = () => {
    return (
        <div className="p-6 bg-white rounded-xl shadow-lg">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">Image Compressor</h2>
            <p className="text-slate-600 mb-4">Compress your images while maintaining quality.</p>
