...
const FormatConverter = () => {
    ...
    return (
        <>
            <SEOHead
                title="Image Format Converter - Convert Between Multiple Formats"
                description="Convert images between JPG, PNG, WebP, and other formats. Free online image converter that maintains quality while changing file types."
                canonicalUrl="/categories/conversion/format-converter"
            />
