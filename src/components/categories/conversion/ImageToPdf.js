    ...
    return (
        <>
            <SEOHead
                ...
                description="Convert single or multiple images to PDF format. Create professional PDF documents from your photos with this free online tool."
                canonicalUrl="/categories/conversion/image-to-pdf"
            />
