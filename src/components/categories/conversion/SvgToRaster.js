...
const SvgToRaster = () => {
    ...
    return (
        <>
            <SEOHead
                title="SVG to PNG/JPG Converter - Convert Vector to Raster Images"
                description="Convert SVG vector graphics to PNG or JPG raster formats. Maintain quality at any size with our free online SVG converter."
                canonicalUrl="/categories/conversion/svg-to-raster"
            />
